<?php
    $this->pageTitle = Yii::t('vcos','编辑活动商品');
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                    	<select class="col-xs-10 col-sm-8 col-md-8" id="form-field-select-1" name="activity">
                                            ...
                                            <option value="<?php echo $row['activity_id'];?>" <?php if($activity_product['activity_id']==$row['activity_id']){echo "selected='selected'";}?>><?php echo $row['activity_name']?></option>
                                            <?php }?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                    	<select class="col-xs-10 col-sm-8 col-md-8" id="form-field-select-1" name="product_type">
                                            <option value="3" <?php if($activity_product['product_type']==3){echo "selected='selected'";}?>>店铺</option>
                                            <option value="4" <?php if($activity_product['product_type']==4){echo "selected='selected'";}?>>活动</option>
                                            <option value="6" <?php if($activity_product['product_type']==6){echo "selected='selected'";}?>>商品</option>
                                        </select>
                                        <?php echo $form->error($activity_product,'product_type'); ?> 
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group shop_sel <?php if($activity_product['product_type']!=3){echo "hidden";}?>">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                    	<select class="col-xs-10 col-sm-8 col-md-8" id="form-field-select-1" name="shop">
                                            ...
                                            <option value="<?php echo $row['shop_id'];?>" <?php if($activity_product['product_id']==$row['shop_id']){echo "selected='selected'";}?>><?php echo $row['shop_title']?></option>
                                            <?php }?>
                                        </select>
                                ...
                                <div class="space-4"></div>
                                <div class="form-group activity_sel <?php if($activity_product['product_type']!=4){echo "hidden";}?>">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', '活动')?>：</label>
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                    	<select class="col-xs-10 col-sm-8 col-md-8" id="form-field-select-1" name="activity_child">
                                    		<?php foreach($activity_child as $row){?>
                                            <option value="<?php echo $row['activity_id'];?>" <?php if($activity_product['product_id']==$row['activity_id']){echo "selected='selected'";}?>><?php echo $row['activity_name']?></option>
                                            <?php }?>
                                        </select>
                                        <?php echo $form->error($activity_product,'product_id'); ?> 
                                    </div>
                                ...
                                <div class="space-4"></div>
                                <div class="form-group product_sel <?php if($activity_product['product_type']!=6){echo "hidden";}?>">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                    	...
                                    	<select style="width:35%;" id="form-field-select-1" name="product">
                                            ...
                                            <option value="<?php echo $row['product_id'];?>" <?php if($activity_product['product_id']==$row['product_id']){echo "selected='selected'";}?>><?php echo $row['product_name']?></option>
                                            <?php }?>
                                        </select>
                                        <?php echo $form->error($activity_product,'product_id'); ?> 
                                    </div>
                                ...
                                <div class="space-4"></div>
                                <div class="form-group  category_sel <?php if($activity_product['product_type']!=6){echo "hidden";}?>">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                    	<select class="col-xs-10 col-sm-8 col-md-8" id="form-field-select-1" name="activity_category">
                                            ...
                                            <option value="<?php echo $row['activity_cid'];?>" <?php if($activity_product['activity_cid']==$row['activity_cid']){echo "selected='selected'";}?>><?php echo $row['activity_category_name']?></option>
                                            <?php }?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="sort" placeholder="<?php echo yii::t('vcos', '排序')?>" class="col-xs-10 col-sm-8 col-md-8" name="sort" maxlength="10" value="<?php echo $activity_product['sort_order']?>" />
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6 col-sm-6 col-md-5">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="text" name="time" id="time" value="<?php echo substr($activity_product['start_show_time'],0,10).' - '.substr($activity_product['end_show_time'],0,10)?>" data-rel="tooltip" title="开始时间为当天00:00:00,结束时间为当天23:59:59" data-placement="bottom"/>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5 col-sm-5 col-md-5 input-group bootstrap-timepicker">
                                        <input id="stime" name="stime" type="text" class="form-control col-xs-8 col-sm-8 col-md-8" maxlength="100" placeholder="<?php echo yii::t('vcos', '开始时间')?>" value="<?php echo substr($activity_product['start_show_time'],11,-1)?>"/>
                                        <span class="input-group-addon">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5 col-sm-5 col-md-5 input-group bootstrap-timepicker">
                                        <input id="etime" name="etime" type="text" class="form-control col-xs-6 col-sm-6 col-md-6" maxlength="100" placeholder="<?php echo yii::t('vcos', '结束时间')?>" value="<?php echo substr($activity_product['end_show_time'],11,-1)?>"/>
                                        <span class="input-group-addon">
                                            <i class="icon-time bigger-110"></i>
                                        </span>
                                    </div>
