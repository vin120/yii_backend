                                        ...
                                        <div class="col-xs-12">
                                            <div class="table-responsive">
                                            	...
                                            	<div class="list_select_option">
                                             	  ...
                                             	  <?php
                                             	  foreach($activity_sel as $row){
                                             	  	$path_url = Yii::app()->createUrl('Activity/activity_product_list',array('type'=> $type_but,'activity'=> $row['activity_id']));
                                             	  ?>
                                             	  	<option value="<?php echo $path_url;?>" <?php if($row['activity_id'] == $activity_but){echo 'selected';}?>><?php echo $row['activity_name']?></option>
                                             	  <?php }?>
                                             	  </select>
                                             	  <label><?php echo yii::t('vcos', '请选择活动类型')?>:</label>
                                             	  <select class='city_sel' name='type_all_sel'>
                                             	  <?php $path_url_all = Yii::app()->createUrl('Activity/activity_product_list',array('activity'=> $activity_but,'type'=>'0'));?>
                                             	  	<option value="<?php echo $path_url_all;?>" <?php if($type_but == 0){echo "selected='selected'";}?>><?php echo yii::t('vcos', '全部')?></option>
                                             	  <?php $path_url_shop = Yii::app()->createUrl('Activity/activity_product_list',array('activity'=> $activity_but,'type'=>'3'));?>
                                             	  	<option value="<?php echo $path_url_shop;?>" <?php if($type_but == 3){echo "selected='selected'";}?>><?php echo yii::t('vcos', '店铺')?></option>
                                             	  <?php $path_url_activity = Yii::app()->createUrl('Activity/activity_product_list',array('activity'=> $activity_but,'type'=>'4'));?>
                                             	  	<option value="<?php echo $path_url_activity;?>" <?php if($type_but == 4){echo "selected='selected'";}?>><?php echo yii::t('vcos', '活动')?></option>
                                             	  <?php $path_url_product = Yii::app()->createUrl('Activity/activity_product_list',array('activity'=> $activity_but,'type'=>'6'));?>
                                                ...
                                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo ++$key;?></td>
                                                            <td><?php echo $activity_first_name['activity_name'];?></td>
                ...
                buttons: [
                    {
                        ...
                        click: function() {
                            location.href="<?php echo Yii::app()->createUrl("Activity/activity_product_list");?>"+"?id="+$a;
                            $( this ).dialog( "close" );
                        }
                    }
                    ,
