<?php
    $this->pageTitle = Yii::t('vcos','餐厅图片管理');
...
<?php 
    ...
    if(in_array('157', $auth) || $auth[0] == '0'){
        $canadd = TRUE;
    }  else {
        $canadd = False;
    }
    if(in_array('159', $auth) || $auth[0] == '0'){
        $canedit = TRUE;
    }  else {
        $canedit = False;
    }
    if(in_array('161', $auth) || $auth[0] == '0'){
        $candelete = TRUE;
    }  else {
        $candelete = FALSE;
    }
                                    ...
                                    <div class="row">
                                        ...
                                        .restaurant_sel{margin-left:20px;width:250px;}
                                            ...
                                            <div class="list_select_option">
                                             	  ...
                                             	  <?php $path_url = Yii::app()->createUrl('Restaurant/restaurant_img_list',array('restaurant'=> 0,'res'=>$res));?>
                                             	  ...
                                             	  <?php foreach($restaurant_sel as $row){
                                             	  	$path_url = Yii::app()->createUrl('Restaurant/restaurant_img_list',array('restaurant'=> $row['restaurant_id'],'res'=>$res));
                                             	  ?>
                                             	  ...
                                             	  <?php $path_url_all = Yii::app()->createUrl('Restaurant/restaurant_img_list',array('res'=> 'all','restaurant'=>$res_but));?>
                                             	  	<option value="<?php echo $path_url_all;?>" <?php if($res == 'all'){echo "selected='selected'";}?>><?php echo yii::t('vcos', '全部')?></option>
                                             	  <?php $path_url_zh = Yii::app()->createUrl('Restaurant/restaurant_img_list',array('res'=> 'zh_cn','restaurant'=>$res_but));?>
                                             	  	<option value="<?php echo $path_url_zh;?>" <?php if($res == 'zh_cn'){echo "selected='selected'";}?>><?php echo yii::t('vcos', '中文')?></option>
                                             	  <?php $path_url_en = Yii::app()->createUrl('Restaurant/restaurant_img_list',array('res'=> 'en','restaurant'=>$res_but));?>
                                                            ...
                                                            <td>
                                                                <?php
                                                                    ...
                                                                    $this->widget('ManipulateWidget',array(
                                                                        ...
                                                                        'MethodName'=>'restaurant_img_edit',
                                                                        'id'=>$row['id'],
                                                                        'canedit'=>$canedit,
                                                                        'candelete'=>$candelete,
                                                                    ));
            ...
            buttons: [
                {
                    ...
                    click: function() {
                        location.href="<?php echo Yii::app()->createUrl("Restaurant/restaurant_img_list");?>"+"?id="+$a;
                        $( this ).dialog( "close" );
                    }
                }
                ,
