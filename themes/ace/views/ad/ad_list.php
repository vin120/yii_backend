<?php
    $this->pageTitle = Yii::t('vcos','广告列表');
...
<?php 
    ...
    if(in_array('109', $auth) || $auth[0] == '0'){
        $canadd = TRUE;
    }  else {
        $canadd = False;
    }
    if(in_array('110', $auth) || $auth[0] == '0'){
        $canedit = TRUE;
    }  else {
        $canedit = False;
    }
    if(in_array('111', $auth) || $auth[0] == '0'){
        $candelete = TRUE;
    }  else {
        $candelete = FALSE;
    }
                                                ...
                                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th><?php echo yii::t('vcos', '广告名')?></th>
                                                            <th><?php echo yii::t('vcos', '广告图')?></th>
                                                            <th><?php echo yii::t('vcos', '跳转方式')?></th>
                                                            <th><?php echo yii::t('vcos', '跳转链接')?></th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="center">
                                                                <label>
                                                                    <input type="checkbox" name="ids[]" value="<?php echo $row['ad_id'];?>" class="ace isclick" />
                                                                    <span class="lbl"></span>
                                                                </label>
                                                            </td>
                                                            <td><?php echo ++$key;?></td>
                                                            ...
                                                            <td><?php if($row['link_type']==0){echo yii::t('vcos', '模块跳转');}elseif($row['link_type']==1){echo yii::t('vcos', 'http跳转');} ?></td>
                                                            <td><?php echo $row['link_url']?></td>
                                                            <td><?php echo $row['ad_state']?yii::t('vcos', '启用'):yii::t('vcos', '禁用');?></td>
                                                            <td>
                                                                <?php
                ...
                buttons: [
                    {
                        ...
                        click: function() {
                            location.href="<?php echo Yii::app()->createUrl("Ad/ad_list");?>"+"?id="+$a;
                            $( this ).dialog( "close" );
                        }
                    }
                    ,
