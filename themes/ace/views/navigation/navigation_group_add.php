<?php
    $this->pageTitle = Yii::t('vcos','添加导航组');
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?>  
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                    	<select class="col-xs-10 col-sm-8 col-md-8" id="form-field-select-1" name="navigation">
                                            ...
                                            <option value="<?php echo $row['navigation_id']?>"><?php echo $row['navigation_name']?></option>
                                            <?php }?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="name" placeholder="<?php echo yii::t('vcos', '导航组名')?>" class="col-xs-10 col-sm-8 col-md-8" name="name" maxlength="10" />
                                ...
                                <div class="form-group">
                                    ...
                                    <?php echo $form->error($navigation_group,'img_url'); ?> 
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
