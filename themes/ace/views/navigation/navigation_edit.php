                        ...
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                    	<select class="col-xs-10 col-sm-8 col-md-8" id="form-field-select-1" name="nav_type">
                                            <option value="1" <?php if($navigation['navigation_style_type']==1){echo "selected='selected'";}?>>手机</option>
                                            <option value="2" <?php if($navigation['navigation_style_type']==2){echo "selected='selected'";}?>>网页</option>
                                        </select>
                                        <?php echo $form->error($navigation,'navigation_style_type'); ?> 
                                    </div>
                                </div>
