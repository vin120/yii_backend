<?php
    $this->pageTitle = Yii::t('vcos','邮轮信息分类列表');
    $theme_url = Yii::app()->theme->baseUrl;
    
    $menu_type = 'cruiseinfocategory';
?>
<?php 
    //navbar 挂件
                                        ...
                                        <div class="col-xs-12">
                                            <div class="table-responsive">
                                                ...
                                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th><?php echo yii::t('vcos', '邮轮信息分类名称')?></th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo ++$key;?></td>
                                                            <td><?php echo $row['cruise_info_category_name'];?></td>
                                                            <td><?php echo $row['category_href_url'];?></td>
                                                            <td><?php echo $row['state']?yii::t('vcos', '启用'):yii::t('vcos', '禁用');?></td>
                                                            <td>
                                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                                    <a href="<?php echo Yii::app()->createUrl("Systemsetting/cruiseinfocategory_edit?id={$row['id']}");?>" class="btn btn-xs btn-info" title="<?php echo yii::t('vcos', '编辑');?>">
                                                                ...
                                                                <div class="visible-xs visible-sm hidden-md hidden-lg">
                                                                    <div class="inline position-relative">
                                                                        ...
                                                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                                            <li>
                                                                                <a href="<?php echo Yii::app()->createUrl("Systemsetting/cruiseinfocategory_edit?id={$row['id']}");?>" class="tooltip-info" data-rel="tooltip" title="<?php echo yii::t('vcos', '编辑');?>">
                                                                                    <span class="green">
                                                                                        <i class="icon-edit bigger-120"></i>
                                                                                    </span>
                                                                                </a>
                                                ...
                                                <div class="center">
                                                    ...
                                                    <a href="<?php echo Yii::app()->createUrl('Systemsetting/cruiseinfocategory_add');?>" class="btn btn-xs">
            ...
            buttons: [
                {
                    ...
                    click: function() {
                        location.href="<?php echo Yii::app()->createUrl("Systemsetting/cruiseinfocategory");?>"+"?id="+$a;
                        $( this ).dialog( "close" );
                    }
                }
                ,
