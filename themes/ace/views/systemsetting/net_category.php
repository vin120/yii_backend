<?php
    $this->pageTitle = Yii::t('vcos','网络通信分类列表');
...
<?php 
    ...
    if(in_array('53', $auth) || $auth[0] == '0'){
        $canadd = TRUE;
    }  else {
        $canadd = False;
    }
    if(in_array('54', $auth) || $auth[0] == '0'){
        $canedit = TRUE;
    }  else {
        $canedit = False;
    }
    if(in_array('55', $auth) || $auth[0] == '0'){
        $candelete = TRUE;
    }  else {
        $candelete = FALSE;
    }
                                                ...
                                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th><?php echo yii::t('vcos', '网络通信分类名')?></th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $row['wifi_price']/100;?></td>
                                                            <?php 
                                                            $hour = floor($row['wifi_time']/60);
                                                            $minute = $row['wifi_time']%60;
                                                            ...
                                                            ?>
                                                            <td><?php echo $str;?></td>
                                                            <td><?php echo $row['wifi_state']?yii::t('vcos', '启用'):yii::t('vcos', '禁用');?></td>
                                                            <td>
                                                                <?php
                                                                    $this->widget('ManipulateWidget',array(
                                                                        'ControllerName'=>'Systemsetting',
                                                                        'MethodName'=>'net_category_edit',
                                                                        'id'=>$row['wifi_id'],
                                                                        'canedit'=>$canedit,
                                                                        'candelete'=>$candelete,
                                                                    ));
                ...
                buttons: [
                    {
                        ...
                        click: function() {
                            location.href="<?php echo Yii::app()->createUrl("Systemsetting/net_category");?>"+"?id="+$a;
                            $( this ).dialog( "close" );
                        }
                    }
                    ,
