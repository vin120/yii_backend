<?php
    $this->pageTitle = Yii::t('vcos','添加评价与帮助管理分类');
                    ...
                    <div class="page-header">
                        <h1>
                            ...
                            <small>
                                    ...
                                    <?php echo yii::t('vcos', '添加评价与帮助管理分类')?>
                            </small>
                        </h1>
                    </div><!-- /.page-header -->
                    <div class="row">
                            ...
                            <form class="form-horizontal" role="form" method="post" action="" id="add" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="name" placeholder="<?php echo yii::t('vcos', '评价与帮助管理分类名称')?>" class="col-xs-10 col-sm-8 col-md-8" name="name" maxlength="16" />
                                    </div>
                                </div>
