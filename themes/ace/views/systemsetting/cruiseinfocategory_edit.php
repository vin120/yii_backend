<?php
    $this->pageTitle = Yii::t('vcos','添加邮轮信息分类');
    $theme_url = Yii::app()->theme->baseUrl;
    
    $menu_type = 'cruiseinfocategory_add';
?>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            <form class="form-horizontal" role="form" method="post" action="" id="edit" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', '邮轮信息分类名称')?>：</label>
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="name" placeholder="<?php echo yii::t('vcos', '邮轮信息分类名称')?>" class="col-xs-10 col-sm-8 col-md-8" name="name" maxlength="100" value="<?php echo $category['cruise_info_category_name']; ?>" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input class="col-xs-10 col-sm-8 col-md-8" id="url" type="text" name="url" placeholder="<?php echo yii::t('vcos', '跳转地址')?>" value="<?php echo $category['category_href_url']; ?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="<?php echo Yii::app()->params['imgurl'].$category['cruise_info_category_img_url'];?>" class="col-xs-3 col-sm-3 col-md-3" title="<?php echo yii::t('vcos', '原图片')?>" />
