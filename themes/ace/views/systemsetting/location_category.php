<?php
    $this->pageTitle = Yii::t('vcos','安全定位分类列表');
                                        ...
                                        <div class="col-xs-12">
                                            <div class="table-responsive">
                                                ...
                                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th><?php echo yii::t('vcos', '安全定位分类名')?></th>
                                                            <th><?php echo yii::t('vcos', '跳转地址')?></th>
                                                            <th><?php echo yii::t('vcos', '背景颜色')?></th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo ++$key;?></td>
                                                            <td><?php echo $row['location_category_name'];?></td>
                                                            <td><?php echo $row['location_category_herf_url'];?></td>
                                                            <td><?php echo $row['bg_color'];?></td>
                                                            <td><?php echo $row['state']?yii::t('vcos', '启用'):yii::t('vcos', '禁用');?></td>
                                                            <td>
                                                                <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                                                    <a href="<?php echo Yii::app()->createUrl("Systemsetting/location_category_edit?id={$row['id']}");?>" class="btn btn-xs btn-info" title="<?php echo yii::t('vcos', '编辑');?>">
                                                                ...
                                                                <div class="visible-xs visible-sm hidden-md hidden-lg">
                                                                    <div class="inline position-relative">
                                                                        ...
                                                                        <ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                                            <li>
                                                                                <a href="<?php echo Yii::app()->createUrl("Systemsetting/location_category_edit?id={$row['id']}");?>" class="tooltip-info" data-rel="tooltip" title="<?php echo yii::t('vcos', '编辑');?>">
                                                                                    <span class="green">
                                                                                        <i class="icon-edit bigger-120"></i>
                                                                                    </span>
                                                                                </a>
                                                ...
                                                <div class="center">
                                                    ...
                                                    <a href="<?php echo Yii::app()->createUrl('Systemsetting/location_category_add');?>" class="btn btn-xs">
            ...
            buttons: [
                {
                    ...
                    click: function() {
                        location.href="<?php echo Yii::app()->createUrl("Systemsetting/location_category");?>"+"?id="+$a;
                        $( this ).dialog( "close" );
                    }
                }
                ,
