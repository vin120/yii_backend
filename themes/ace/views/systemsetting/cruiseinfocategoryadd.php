                            ...
                            <form class="form-horizontal" role="form" method="post" action="" id="add" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="name" placeholder="<?php echo yii::t('vcos', '邮轮信息分类名称')?>" class="col-xs-10 col-sm-8 col-md-8" name="name" maxlength="100" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input class="col-xs-10 col-sm-8 col-md-8" id="url" type="text" name="url" placeholder="<?php echo yii::t('vcos', '跳转地址')?>" />
                                    </div>
                                </div>
                                <div class="form-group">
...
jQuery(function($){
    $("#add").validate({
        ...
        messages:{
            name:"<?php echo yii::t('vcos', '请输入邮轮信息分类名称')?>",
