<?php
    $this->pageTitle = Yii::t('vcos','分类管理');
...
<?php 
    ...
    if(in_array('235', $auth) || $auth[0] == '0'){
        $canadd = TRUE;
    }  else {
        $canadd = False;
    }
    if(in_array('237', $auth) || $auth[0] == '0'){
        $canedit = TRUE;
    }  else {
        $canedit = False;
    }
    if(in_array('239', $auth) || $auth[0] == '0'){
        $candelete = TRUE;
    }  else {
        $candelete = FALSE;
    }
                                                ...
                                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="center">
                                                                <label>
                                                                    <input type="checkbox" name="ids[]" value="<?php echo $row['main_id'];?>" class="ace isclick" />
                                                                    <span class="lbl"></span>
                                                                </label>
                                                            </td>
                                                            <td><?php echo ++$key;?></td>
                ...
                buttons: [
                    {
                        ...
                        click: function() {
                            //location.href="<?php echo Yii::app()->createUrl("Main/main_category_list");?>"+"?id="+$a;
                            location.href="<?php echo Yii::app()->createUrl("Main/main_category_list");?>"+"?id="+$a;
                            $( this ).dialog( "close" );
                        }
                    }
