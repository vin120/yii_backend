<?php
    $this->pageTitle = Yii::t('vcos','常见问题分类列表');
...
<?php 
    ...
    if(in_array('267', $auth) || $auth[0] == '0'){
        $canadd = TRUE;
    }  else {
        $canadd = False;
    }
    if(in_array('269', $auth) || $auth[0] == '0'){
        $canedit = TRUE;
    }  else {
        $canedit = False;
    }
    if(in_array('271', $auth) || $auth[0] == '0'){
        $candelete = TRUE;
    }  else {
        $candelete = FALSE;
    }
                                        ...
                                        <div class="col-xs-12">
                                            <div class="table-responsive">
                                                ...
                                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($help_category as $key=>$row) { ?>
                                                        <tr>
                                                            <td><?php echo ++$key;?></td>
            ...
            buttons: [
                {
                    ...
                    "id" : "danger1",
                    click: function() {
                        location.href="<?php echo Yii::app()->createUrl("Commentandhelp/help_category");?>"+"?id="+$a;
                        $( this ).dialog( "close" );
                    }
                }
                ,
