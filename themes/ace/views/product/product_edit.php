                            ...
                            ?> 
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6 col-sm-6 col-md-5">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="text" name="time" id="time" value="<?php echo substr($product['sale_start_time'],0,10).' - '.substr($product['sale_end_time'],0,10)?>" data-rel="tooltip" title="开始时间为当天00:00:00,结束时间为当天23:59:59" data-placement="bottom"/>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5 col-sm-5 col-md-5 input-group bootstrap-timepicker">
                                        <input id="stime" name="stime" type="text" class="form-control col-xs-8 col-sm-8 col-md-8" maxlength="100" placeholder="<?php echo yii::t('vcos', '开始时间')?>" value="<?php echo substr($product['sale_start_time'],11,-1)?>"/>
                                        <span class="input-group-addon">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5 col-sm-5 col-md-5 input-group bootstrap-timepicker">
                                        <input id="etime" name="etime" type="text" class="form-control col-xs-6 col-sm-6 col-md-6" maxlength="100" placeholder="<?php echo yii::t('vcos', '结束时间')?>" value="<?php echo substr($product['sale_end_time'],11,-1)?>"/>
                                        <span class="input-group-addon">
                                            <i class="icon-time bigger-110"></i>
                                        </span>
                                    </div>
