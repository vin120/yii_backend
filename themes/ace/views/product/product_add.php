                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?> 
                                ...
                                <div class="space-4"></div>
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', '定时上架日期')?>：</label>
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                    	<input type='checkbox' style="position:relative;top:2px;margin-left:5px;margin-right:2px;" name="up" value='1'/>设定
                                ...
                                <div class="space-4"></div>
                                <div class="form-group">
                                    <label class="col-xs-2 col-sm-2 col-md-2 control-label no-padding-right"><?php echo yii::t('vcos', '定时下架日期')?>：</label>
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                    	<input type='checkbox' style="position:relative;top:2px;margin-left:5px;margin-right:2px;" name="down" value='1'/>设定
                                ...
                                <div class="space-4"></div>
                                <input type="submit" value="<?php echo yii::t('vcos', '保存且下架')?>" id="submit" class="btn btn-primary" style="margin-left:40%"/>
                                <input type="submit" value="<?php echo yii::t('vcos', '开始销售')?>" id="submit" class="btn btn-primary" style="margin-left:2%;"/>
                            <?php  
                                $this->endWidget();  
                            ?>
                        </div><!-- /.col-xs-12 -->
