<?php
    $this->pageTitle = Yii::t('vcos','添加新商品');
                            ...
                            ?> 
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="radio" class="iso_choose" name="language" value="en" />English
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="titles" placeholder="<?php echo yii::t('vcos', '商品名')?>" class="col-xs-10 col-sm-8 col-md-8" name="title" maxlength="80" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input class="col-xs-10 col-sm-8 col-md-8" id="info" type="text" name="info" placeholder="<?php echo yii::t('vcos', '介绍')?>" maxlength="80"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <select class="col-xs-10 col-sm-8 col-md-8" id="form-field-select-1" name="type">
                                            ...
                                            <option value="<?php echo $row['gc_id']?>"><?php echo $row['gc_name'];?></option>
                                            <?php }?>
                                        </select>
                                        <?php echo $form->error($goods,'goods_category'); ?> 
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                <div class="form-group">
                                    ...
                                    <?php echo $form->error($goods,'goods_img_url'); ?> 
                                </div>
                                <div class="space-4"></div>
