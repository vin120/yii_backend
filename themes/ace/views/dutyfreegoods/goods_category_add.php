<?php
    $this->pageTitle = Yii::t('vcos','添加新商品分类');
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-11">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-8 col-md-7">
                                        <input type="text" id="titles" placeholder="<?php echo yii::t('vcos', '商品分类名')?>" class="col-xs-10 col-sm-8 col-md-8" name="title" maxlength="80" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6">
                                        ...
                                        <?php echo $form->error($category,'gc_img_url'); ?> 
                                    </div>
                                </div>
                                <div class="space-4"></div>
