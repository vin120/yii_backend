...
class ProductController extends Controller
{
	...
	public function actionProduct_list(){
		...
		if(isset($_GET['cat_code']) && $_GET['cat_code']!=''){
			$code_id = $_GET['cat_code'];
		}else{
	...
	public function actionProduct_detail_list(){
		...
		$this->render('product_detail_list',array('pages'=>$pager,'auth'=>$this->auth,'product_detail'=>$product_detail));
	} 
	...
	public function actionProduct_img_list(){
		...
		//渲染页面
		$this->render('product_img_list',array('pages'=>$pager,'auth'=>$this->auth,'product_img'=>$product_img));
	}
	...
	public function actionProduct_graphic_list(){
		...
		//渲染页面
		$this->render('product_graphic_list',array('pages'=>$pager,'auth'=>$this->auth,'product_graphic'=>$product_graphic));	
	}
